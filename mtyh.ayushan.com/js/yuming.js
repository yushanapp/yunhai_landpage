...
// if(thisHost.indexOf('yushan')>=0 || thisHost.indexOf('zjzhidao')>=0 || thisHost.indexOf('zjzdao')>=0){
  ...
  $('.banben').html('<span style="font-size:12px">北京智投智道投资咨询有限公司版权所有<br><span><a href="http://www.beian.miit.gov.cn">京ICP备15010702号-1</a></span></span><br> <span style="transform:scale(0.5)">地址：昌平区昌崔路198号院2号楼</span><br> <span style="transform:scale(0.5)">联系电话：15010903351</span>版权所有');
  ...
  $(".bai").attr('src','http://test.myushan.com//lanpeg/yslogo.png');
    ...
    $('.banben').html('<span style="font-size:14px">北京智鸟科技有限公司版权所有<br><span><a href="http://www.beian.miit.gov.cn">京ICP备16054220号-1</a></span></span><br>
...
<span style="transform:scale(0.5)">联系电话：13051230120</span></div>');
  ...
  $('.banben').text('<span style="font-size:12px">北京智道未来网络科技有限公司版权所有<br><span><a href="http://www.beian.miit.gov.cn">京ICP备15031264号-1</a></span></span><br>
