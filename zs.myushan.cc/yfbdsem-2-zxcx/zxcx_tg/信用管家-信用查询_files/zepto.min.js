/* Zepto 1.1.6 - zepto detect event ajax form ie fx fx_methods data assets selector - zeptojs.com/license */
var Zepto = function () {
    function Z(t) {
    ...
    function _(t) {
        return $(t) && !M(t) && Object.getPrototypeOf(t) == Object.prototype
    }
    ...
    function X(n, i, r) {
        for (e in i) r && (_(i[e]) || k(i[e])) ? (_(i[e]) && !_(n[e]) && (n[e] = {}), k(i[e]) && !k(n[e]) && (n[e] = []), X(n[e], i[e], r)) : i[e] !== t && (n[e] = i[e])
    }
    ...
    var t, e, n, i, O, P, r = [], o = r.concat, s = r.filter, a = r.slice, u = window.document, f = {}, c = {},
        l = {"column-count": 1, columns: 1, "font-weight": 1, "line-height": 1, opacity: 1, "z-index": 1, zoom: 1},
        h = /^\s*<(\w+|!)[^>]*>/, p = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
        d = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, m = /^(?:body|html)$/i,
        v = /([A-Z])/g, g = ["val", "css", "html", "text", "data", "width", "height", "offset"],
        y = ["after", "prepend", "before", "append"], b = u.createElement("table"), x = u.createElement("tr"),
        w = {tr: u.createElement("tbody"), tbody: b, thead: b, tfoot: b, td: x, th: x, "*": u.createElement("div")},
        E = /complete|loaded|interactive/, T = /^[\w-]*$/, S = {}, j = S.toString, C = {}, A = u.createElement("div"),
        N = {
            tabindex: "tabIndex",
            readonly: "readOnly",
            "for": "htmlFor",
    ...
    return C.matches = function (t, e) {
        ...
        return o && (r = A).appendChild(t), i = ~C.qsa(r, e).indexOf(t), o && A.removeChild(t), i
    }, O = function (t) {
        ...
        var o, s, f;
        return p.test(e) && (o = n(u.createElement(RegExp.$1))), o || (e.replace && (e = e.replace(d, "<$1></$2>")), i === t && (i = h.test(e) && RegExp.$1), i in w || (i = "*"), f = w[i], f.innerHTML = "" + e, o = n.each(a.call(f.childNodes), function () {
            f.removeChild(this)
        })), _(r) && (s = n(o), n.each(r, function (t, e) {
            g.indexOf(t) > -1 ? s[t](e) : s.attr(t, e)
        })), o
    }, C.Z = function (t, e) {
        return new W(t, e)
    }, C.isZ = function (t) {
        ...
        if ("string" == typeof e) if (e = e.trim(), "<" == e[0] && h.test(e)) r = C.fragment(e, RegExp.$1, i), e = null; else {
            ...
            if (C.isZ(e)) return e;
            if (k(e)) r = z(e); else if ($(e)) r = [e], e = null; else if (h.test(e)) r = C.fragment(e.trim(), RegExp.$1, i), e = null; else {
                if (i !== t) return n(i).find(e);
                r = C.qsa(u, e)
            }
        }
        ...
        return !1
    }, n.type = Z, n.isFunction = D, n.isWindow = M, n.isArray = k, n.isPlainObject = _, n.isEmptyObject = function (t) {
        var e;
        for (e in t) return !1;
        return !0
        ...
        var n, r, o, i = [];
        if (F(t)) for (r = 0; r < t.length; r++) n = e(t[r], r), null != n && i.push(n); else for (o in t) n = e(t[o], o), null != n && i.push(n);
        return R(i)
    }, n.each = function (t, e) {
        var n, i;
        if (F(t)) {
        ...
        attr: function (n, i) {
            ...
            return "string" != typeof n || 1 in arguments ? this.each(function (t) {
                if (1 === this.nodeType) if ($(n)) for (e in n) Y(this, e, n[e]); else Y(this, n, J(this, i, t, this.getAttribute(n)))
        ...
        data: function (e, n) {
            var i = "data-" + e.replace(v, "-$1").toLowerCase(), r = 1 in arguments ? this.attr(i, n) : this.attr(i);
            return null !== r ? K(r) : t
        },
        val: function (t) {
            return 0 in arguments ? this.each(function (e) {
        ...
        css: function (t, i) {
            ...
            var a = "";
            if ("string" == Z(t)) i || 0 === i ? a = q(t) + ":" + I(t, i) : this.each(function () {
                this.style.removeProperty(q(t))
            }); else for (e in t) t[e] || 0 === t[e] ? a += q(e) + ":" + I(e, t[e]) + ";" : this.each(function () {
        ...
        n.fn[e] = function (r) {
            var o, s = this[0];
            return r === t ? M(s) ? s["inner" + i] : L(s) ? s.documentElement["scroll" + i] : (o = this.offset()) && o[e] : this.each(function (t) {
    ...
    }), C.Z.prototype = W.prototype = n.fn, C.uniq = P, C.deserializeValue = K, n.zepto = C, n
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    function e(t, e) {
        ...
        (i.webkit = !!r) && (i.version = r[1]), o && (n.android = !0, n.version = o[2]), f && !u && (n.ios = n.iphone = !0, n.version = f[2].replace(/_/g, ".")), a && (n.ios = n.ipad = !0, n.version = a[2].replace(/_/g, ".")), u && (n.ios = n.ipod = !0, n.version = u[3] ? u[3].replace(/_/g, ".") : null), h && (n.wp = !0, n.version = h[1]), c && (n.webos = !0, n.version = c[2]), p && (n.touchpad = !0), v && (n.blackberry = !0, n.version = v[2]), g && (n.bb10 = !0, n.version = g[2]), y && (n.rimtabletos = !0, n.version = y[2]), b && (i.playbook = !0), d && (n.kindle = !0, n.version = d[1]), m && (i.silk = !0, i.version = m[1]), !m && n.android && t.match(/Kindle Fire/) && (i.silk = !0), x && (i.chrome = !0, i.version = x[1]), w && (i.firefox = !0, i.version = w[1]), E && (n.firefoxos = !0, n.version = E[1]), T && (i.ie = !0, i.version = T[1]), j && (s || n.ios || l) && (i.safari = !0, n.ios || (i.version = j[1])), S && (i.webview = !0), n.tablet = !!(a || b || o && !t.match(/Mobile/) || w && t.match(/Tablet/) || T && !t.match(/Phone/) && t.match(/Touch/)), n.phone = !(n.tablet || n.ipod || !(o || f || c || v || g || x && t.match(/Android/) || x && t.match(/CriOS\/([\d.]+)/) || w && t.match(/Mobile/) || T && t.match(/Touch/)))
    }
    ...
    function g(e, i, r, o, a, u, f) {
        ...
        i.split(/\s/).forEach(function (i) {
            ...
            }, s.i = d.length, d.push(s), "addEventListener" in e && e.addEventListener(v(s.e), s.proxy, m(s, f))
        })
    }
    ...
    function y(t, e, n, i, r) {
        ...
        (e || "").split(/\s/).forEach(function (e) {
            h(t, e, n, i).forEach(function (e) {
                delete s[o][e.i], "removeEventListener" in t && t.removeEventListener(v(e.e), e.proxy, m(e, r))
            })
        })
    }
    ...
    l.href = window.location.href, t.active = 0, t.ajaxJSONP = function (i, r) {
        ...
        return r && r.promise(l), t(a).on("load error", function (e, n) {
            clearTimeout(h), t(a).off().remove(), "error" != e.type && f ? g(f[0], l, i, r) : y(null, n || "error", l, i, r), window[s] = u, f && t.isFunction(u) && u(f[0]), u = f = void 0
        }), v(l, i) === !1 ? (c("abort"), l) : (window[s] = function () {
            f = arguments
                ...
                if (4 == j.readyState) {
                    ...
                    if (j.status >= 200 && j.status < 300 || 304 == j.status || 0 == j.status && "file:" == S) {
                        if (f = f || w(o.mimeType || j.getResponseHeader("content-type")), "arraybuffer" == j.responseType || "blob" == j.responseType) e = j.response; else {
                            ...
                            if (n) return y(n, "parsererror", j, o, s)
                        }
                        g(e, j, o, s)
                    } else y(j.statusText || null, j.status ? "error" : "abort", j, o, s)
                }
            }, v(j, o) === !1) return j.abort(), y(null, "abort", j, o, s), j;
    ...
    var i, a, u, f, c, l, h, p, d, m, n = "", r = {Webkit: "webkit", Moz: "", O: "o"},
        ...
        s = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, v = {};
    t.each(r, function (t, r) {
        return o.style[t + "TransitionProperty"] !== e ? (n = "-" + t.toLowerCase() + "-", i = r, !1) : void 0
    }), a = n + "transform", v[u = n + "transition-property"] = v[f = n + "transition-duration"] = v[l = n + "transition-delay"] = v[c = n + "transition-timing-function"] = v[h = n + "animation-name"] = v[p = n + "animation-duration"] = v[m = n + "animation-delay"] = v[d = n + "animation-timing-function"] = "", t.fx = {
        ...
        if (i === e && (i = t.fx.speeds._default / 1e3), y === e && (y = 0), t.fx.off && (i = 0), "string" == typeof n) x[h] = n, x[p] = i + "s", x[m] = y + "s", x[d] = r || "linear", j = t.fx.animationEnd; else {
            w = [];
            for (b in n) s.test(b) ? E += b + "(" + n[b] + ") " : (x[b] = n[b], w.push(g(b)));
        ...
        return S = function (e) {
            ...
            C = !0, t(this).css(v), o && o.call(this)
