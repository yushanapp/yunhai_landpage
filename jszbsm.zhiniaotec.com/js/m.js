var livePage = {
    downUrl_AN: '',
    downUrl_IOS:'http://mobile.9158.com/download/Orange_Mob008.apk',
    setTimer1: null,
    setTimer2: null,
    setTimer3: null,
    iosOffLine: true,
    ...
    getDownUrl: function() {
        var _this = this;
        // 2个链接：http://mobile.9158.com/download/Orange_Mob008.apk
       // http://mobile.9158.com/download/Orange_Mob009.apk
        /*_this.qd = _this.getURLParameter('qd') || 'BDSJ_1';*/
        _this.qd = _this.getURLParameter('cid') || 'Orange_Mob008';
        _this.downUrl_AN = 'http://mobile.9158.com/download/'+_this.qd + '.apk';
        if (_this.sysTemInfo() == 'ios') {
            /*_this.appKey = 'vkvfsm', _this.qd = 'ios' + _this.qd;*/
           _this.downUrl_IOS = 'http://mobile.9158.com/download/'+_this.qd + '.apk';
