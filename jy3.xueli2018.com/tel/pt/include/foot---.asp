...
<img id="wx" src="/wx/ii5599.gif" style="position:fixed;_position:absolute; bottom:93px; right:0px; z-index:11; width:60px;" >
...
<a href="javascript:void(0)" onClick="document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'" id="fade" style="position:fixed;_position:absolute; top:0px; left:0px; z-index:29;background:#000; width:100%; height:100%; display:none; filter: alpha(opacity=50); opacity:0.5;"></a>
    ...
    <div id="foot"><!--a href="/tel/hb/"><img style="position:absolute; z-index:200; left:0px;top:-89px;" src="/img2/hongbao.gif" width="60" /></a><a onclick="doyoo.util.openChat('g=10079387');return false;"><img style="position:absolute; z-index:200; left:0px;top:-83px;" src="/img2/qq.gif" width="50" /></a>
<!--marquee style="position:absolute; z-index:200; left:0px;top:-55px; margin-left:64px; height:14px; display:block; text-shadow:0px 0px 5px white;" onmouseover="this.stop();" onmouseout="this.start();" direction="left" behavior="scroll"><a href="/tel/pt/tzs.asp" style="color:red;font-size:14px; line-height:1;">【录取通知书现已陆续发放，还未报名的同学请抓紧时间报名】</a></marquee-->

    	<ul>
        <li style="width:30%;"><a style="background:#4ac6f9;" onclick="doyoo.util.openChat('g=10079387');return false;"><span>1</span>在线咨询专家</a></li>
        <li style="width:23%;"><a style="background:#7bc31f;" href="tel:13311109354"><img src="/tel/pt/img/phone.png" height="16" />立即通话</a></li>
        <li style="width:19%;"><a style="background:#fb6e72;" href="/tel/pt/bm.asp">在线报名</a></li>
        <li style="width:28%;"><a class="wx" href="javascript:void(0)" onClick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><font color="yellow">加微信号 ii5599</font><br />24小时咨询专家</a></li>
        </ul>
    </div>
...
<script language="javascript" src="/tel/pt/js/take.js" type="text/javascript"></script>
</div>
