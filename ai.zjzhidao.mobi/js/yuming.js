...
// if(thisHost.indexOf('yushan')>=0 || thisHost.indexOf('zjzhidao')>=0 || thisHost.indexOf('zjzdao')>=0){
  ...
  $('.banben').html('<span style="font-size:12px">北京智投智道投资咨询有限公司版权所有</span><br> <span style="transform:scale(0.5)">地址：昌平区昌崔路198号院2号楼</span><br> <span style="transform:scale(0.5)">联系电话：15810015773</span>版权所有');
