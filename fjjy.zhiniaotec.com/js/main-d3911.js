!function(t) {
    ...
    !function() {
        ...
        b.html("ICP备15053624号"), x.html("地址：北京市朝阳区北苑路乙108号14幢")) : g && "lkt" == g ? (w.html("成都乐开天科技有限公司 版权所有"), 
        b.html("ICP备18026322号"), x.html("地址：成都市高新区天府三街69号新希望国际B座4层411室")) : g && "sysd" == g ? (w.html("北京三易时代文化传媒有限公司 版权所有"), 
        b.html("ICP备17064426号"), x.html("地址：北京市朝阳区广华居19号楼2层201")) : g && "jiujy" == g && (w.html("太原市万柏林区九加一科技咨询服务部 版权所有"), 
