!function(t) {
    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        ...
        function d(t) {
            var e, n;
            return A[t] || (e = q.createElement(t), q.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), 
        ...
        var E, T, O, S, P, C, N = [], M = N.concat, L = N.filter, k = N.slice, q = window.document, A = {}, D = {}, I = {
            "column-count": 1,
            columns: 1,
            "font-weight": 1,
            "line-height": 1,
            ...
            "z-index": 1,
            zoom: 1
        }, _ = /^\s*<(\w+|!)[^>]*>/, $ = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, R = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, F = /^(?:body|html)$/i, z = /([A-Z])/g, H = [ "val", "css", "html", "text", "data", "width", "height", "offset" ], Z = [ "after", "prepend", "before", "append" ], U = q.createElement("table"), B = q.createElement("tr"), X = {
        ...
        return J.matches = function(t, e) {
            ...
            var i, r, o;
            return $.test(t) && (i = O(q.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(R, "<$1></$2>")), 
        ...
        }, O.contains = q.documentElement.contains ? function(t, e) {
        ...
        O.isEmptyObject = function(t) {
            ...
            ready: function(t) {
                return V.test(q.readyState) && q.body ? t(O) : q.addEventListener("DOMContentLoaded", function() {
                    t(O);
                }, !1), this;
            },
            get: function(t) {
            ...
            offset: function(t) {
                ...
                if (!O.contains(q.documentElement, this[0])) return {
                    top: 0,
                    left: 0
                };
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (var t = this.offsetParent || q.body; t && !F.test(t.nodeName) && "static" == O(t).css("position"); ) t = t.offsetParent;
                    return t;
                });
            }
            ...
            O.fn[e] = function() {
                ...
                return o.length < 1 ? this : this.each(function(t, e) {
                    ...
                    var s = O.contains(q.documentElement, r);
