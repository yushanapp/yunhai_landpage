!function(t) {
    ...
    i(d);
    !function() {
        var t = (new a.default(document, window), new c.default()), e = new l.default(), n = new p.default(), i = localAddress, o = document.getElementsByTagName("body")[0], s = document.getElementsByClassName("down_btn"), u = $(".askfriend_info .adress"), f = t.from || 1300852, d = t.opena, h = t.backload, m = t.touch, g = new Date(), v = g.getTime(), y = t.tit, w = t.cp, b = "https://ptd.94you.net/apk/download/1308255/yhag_1308255.apk";
        !function() {
            var t, e = (t = {
                fjya: "附近约爱",
                lywb: "来约我吧",
